...
/**
 * A boolean value that represents whether user prefers to upgrade VP. (AT)
 *
 * @discussion When the connected device support updating VP image, this value determines the parameters to be used during the upgrade.
 *
 * The default value is @c NO.
 */
@property BOOL prefersUpgradeVP;
